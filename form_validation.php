...
<head>
  ...
  <title>Smart Bill Details of User</title>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-files-o"></i>Edit Details Of User</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
              <li><i class="fa fa-files-o"></i>Edit Details Of User</li>
            </ol>
          </div>
        </div>
        <!-- Form validations -->
